      ...
      <section style={{ background: C.bg, padding: '72px 40px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(230px, 1fr))', gap: '20px', marginBottom: '60px' }}>
            {BENEFITS.map(b => (
              <div key={b.title} style={{ padding: '26px', border: `1px solid ${C.border}`, borderTop: `3px solid ${C.cyan}` }}>
          ...
          <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', border: `1px solid ${C.border}` }}>
            <iframe
